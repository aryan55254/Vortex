    ...
    <>
      ...
      <div className="relative z-10">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-20">
              <div className="flex items-center">
                ...
                <div className="text-white font-bold text-2xl md:text-3xl ml-2">
                  Vortex
                </div>
              </div>
              <nav className="hidden md:block">
                <div className="ml-10 flex items-center space-x-8">
                  <a
                    href="#features"
                    className="text-white text-lg md:text-xl hover:text-purple-700 transition-colors duration-200"
                  >
                    Features
                  </a>
                  <a
              ...
              <Link to="/auth">
                <button className="text-white text-base md:text-xl cursor-pointer bg-purple-700 hover:bg-purple-900 px-4 py-2 md:px-5 md:py-3 font-bold rounded-md transition-colors duration-200">
                  Get Started
                </button>
              </Link>
            </div>
        ...
        <main>
          ...
          >
            <div className="relative z-10">
              <h1 className="text-4xl sm:text-6xl md:text-7xl font-extrabold tracking-tight uppercase">
              ...
              <div className="mt-10">
                <Link to="/auth">
                  <button className="text-white text-lg md:text-xl cursor-pointer bg-purple-700 hover:bg-purple-900 px-8 py-3 md:px-10 md:py-4 font-bold rounded-lg transition-transform transform hover:scale-105 duration-300">
                    Start Clipping
                  </button>
                </Link>
              </div>
              <div className="flex flex-col sm:flex-row flex-wrap justify-center items-center gap-x-8 gap-y-4 mt-12">
          ...
          <div id="how-it-works" className="py-20 px-4 text-center">
            ...
            <div className="max-w-4xl mx-auto grid md:grid-cols-3 gap-8 text-center text-white">
              <div className="flex flex-col items-center">
                <div className="bg-black/30 backdrop-blur-sm rounded-full h-24 w-24 flex items-center justify-center border-2 border-purple-700 text-purple-700 text-3xl md:text-4xl font-bold">
                  1
                </div>
